# blockchain_project/settings.py
"""
...
SECRET_KEY = 'django-insecure-4zge%d_!k-@xv6=k4sw71#zs_)emrki%r@6pj^l__scceyu7)s'
...
# Session settings for blockchain state persistence
...
BLOCKCHAIN_SESSION_KEY = 'blockchain_data'  # Key for storing blockchain in session
WALLETS_SESSION_KEY = 'user_wallets'  # Key for storing wallets in session